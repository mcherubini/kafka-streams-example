...
public class Weather extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3818449891562970137L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Weather\",\"namespace\":\"com.mcherubini\",\"doc\":\"A weather reading.\",\"fields\":[{\"name\":\"station\",\"type\":\"string\",\"order\":\"ignore\"},{\"name\":\"time\",\"type\":\"long\"},{\"name\":\"temp\",\"type\":\"int\"}]}");
   ...
   */
  public static com.mcherubini.Weather.Builder newBuilder() {
    return new com.mcherubini.Weather.Builder();
  }
   ...
   * @return A new Weather RecordBuilder
   */
  public static com.mcherubini.Weather.Builder newBuilder(com.mcherubini.Weather.Builder other) {
    if (other == null) {
      return new com.mcherubini.Weather.Builder();
    } else {
      return new com.mcherubini.Weather.Builder(other);
    }
  }
   ...
   * @return A new Weather RecordBuilder
   */
  public static com.mcherubini.Weather.Builder newBuilder(com.mcherubini.Weather other) {
    if (other == null) {
      return new com.mcherubini.Weather.Builder();
    } else {
      return new com.mcherubini.Weather.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Weather>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.mcherubini.Weather.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.mcherubini.Weather other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.station)) {
        this.station = data().deepCopy(fields()[0].schema(), other.station);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.mcherubini.Weather.Builder setStation(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.mcherubini.Weather.Builder clearStation() {
      station = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.mcherubini.Weather.Builder setTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.mcherubini.Weather.Builder clearTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.mcherubini.Weather.Builder setTemp(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.mcherubini.Weather.Builder clearTemp() {
